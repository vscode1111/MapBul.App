...
namespace TK.CustomMap.iOSUnified
{
    ...
    internal class TKCustomMapAnnotation : MKAnnotation
    {
        ...
        ///<inheritdoc/>
        public override string Title => this._formsPin.Title;

        ///<inheritdoc/>
        public override string Subtitle => this._formsPin.Subtitle;

        ///<inheritdoc/>
        public override CLLocationCoordinate2D Coordinate => this._formsPin.Position.ToLocationCoordinate();

        /// <summary>
        /// Gets the forms pin
        /// </summary>
        public TKCustomMapPin CustomPin => this._formsPin;
